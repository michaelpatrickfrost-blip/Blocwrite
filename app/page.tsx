    ...
    >
      ...
      <div className="bw-hero-wrap" style={{ ...wrap(), textAlign: "center", padding: "96px 28px 88px", position: "relative", zIndex: 1 }}>
        ...
        <div className="bw-hero-pills" style={{ display: "flex", justifyContent: "center", gap: 10, marginTop: 40, flexWrap: "wrap" }}>
          {["Canon-aware AI", "11-point continuity checks", "Manuscript health score", "Fiction & Non-Fiction", "Character chat", "AI Co-Author", "Writing Packs", "Beta reader sharing", "EPUB & DOCX export", "Bring your own AI key"].map((t) => (
            <span
              key={t}
              style={{
...
const STAGES = [
  ...
  },
  {
    ...
    desc: "Generate a full chapter plan from your synopsis and Canon. Each chapter gets a title, detailed synopsis, named characters, and locations. Arc Intelligence scores your story structure and suggests narrative directions. Sync to your manuscript in one click.",
    details: [
      "One-click chapter generation",
      "Arc Intelligence with scoring",
      "Character and location linking",
      "Sync to manuscript instantly",
    ],
    color: "#8b5cf6",
  ...
  },
  {
    ...
    subtitle: "Intelligence across your entire novel.",
    desc: "Arc Intelligence analyses your story structure and generates scored arc directions — compare them side by side and pick the best fit. The full-manuscript editor scans every chapter for sentence-level improvements with current vs. suggested diffs.",
    details: [
      "Arc Intelligence with scoring",
  ...
  },
  {
    ...
    desc: "Generate a time-limited link and send it to anyone. Readers see your manuscript in a clean branded view, highlight text, and leave annotations — comments, suggestions, or issues. Review feedback with AI-assisted accept or reject. Password-protect if needed.",
    details: [
  ...
  },
  {
    ...
    subtitle: "True stories deserve real tools.",
    desc: "Write memoir, biography, true crime, historical, or investigative non-fiction. A guided Life Interview captures your memories with thoughtful AI questions. Life Events structure your timeline. Emotional mapping and relationship webs bring depth. AI extracts people, places, and themes into your Canon automatically.",
    details: [
      "5 non-fiction subtypes",
      "AI-guided Life Interview",
      "Life Events & Emotional Timeline",
      "Auto-extract to Canon",
    ],
    color: "#06b6d4",
    screenshot: "/screenshots/nonfiction.png?v=3",
  },
];
...
const ADVANCED_FEATURES = [
  ...
  {
    title: "Non-Fiction Mode",
    desc: "Memoir, biography, true crime, historical, investigative. Guided Life Interview, life events, emotional timelines, relationship webs.",
      ...
      <div style={wrap({ textAlign: "center" })}>
        ...
        <div className="bw-pricing-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, maxWidth: 720, margin: "0 auto" }}>
          <PriceCard
            ...
            period="month"
            badge={null}
            features={["Full studio access", "Unlimited novels & chapters", "Canon, Plan, Blocs, Export", "The Editor, Co-Author, Character Chat", "Bolt-Ons & Writing Packs", "Non-Fiction & Biography mode", "Bring your own AI key", "Cancel anytime"]}
          />
          <PriceCard
            name="Annual"
            price="£99"
...
const FAQ_ITEMS = [
  ...
  { q: "Can I share with beta readers?", a: "Yes. Generate a password-protected, time-limited link. Readers see your manuscript in a clean branded view, highlight text, and leave annotations. Review each piece of feedback with AI-assisted accept or reject." },
